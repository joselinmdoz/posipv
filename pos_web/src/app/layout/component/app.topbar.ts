    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <a class="layout-topbar-logo" [routerLink]="homeRoute()">
                @if (systemLogoUrl()) {
                    <img [src]="systemLogoUrl()" [alt]="systemName()" style="height: 2.25rem; width: auto; max-width: 180px; object-fit: contain;" (error)="onLogoError()" />
                } @else {
...
export class AppTopbar implements OnInit {
    ...
    ngOnInit(): void {
        this.settingsService
            ...
            .subscribe((settings) => {
                this.systemName.set((settings.systemName || 'POS System').trim() || 'POS System');
                this.systemLogoUrl.set((settings.systemLogoUrl || '').trim());
            });
        ...
        this.settingsService.getSystemSettings().subscribe({
            ...
            error: () => {
                this.systemName.set('POS System');
                this.systemLogoUrl.set('');
            }
        });
    }
