...
@Component({
    ...
    template: `
        <div class="p-4 flex flex-col gap-4">
            <div>
                <h1 class="text-2xl font-bold mb-1">Contabilidad · Reportes</h1>
                <p class="text-gray-500 m-0">Reportes contables: diario, balanza y mayor.</p>
            </div>
                                ...
                                <tbody>
                                    @for (row of journalReport?.entries || []; track row.id) {
                                        <tr>
                                            ...
                                            <td class="py-2 px-3">{{ formatDateFn(row.date) }}</td>
